---
source: /Users/hinrayleung/Documents/Paper/hpc/osdi24-lin-chaofan (1).pdf
type: pdf
model: mistral-ocr-latest
processed: 2026-01-03T13:07:52.051680
---

# Document: osdi24-lin-chaofan (1).pdf
...
Other Applications of Inter-Request Analysis. The interrequest analysis in Parrot enables a new optimization space not limited to the ones we introduced in §5. A large-scale service has more scheduling features to consider, including
...
Applications programmed by SemanticFunctions or other frontends are finally lowered to requests to universal APIs through different adapters. Parrot provides OpenAI-like APIs with the extension of Semantic Variables. The request body of two operations mentioned in §4.1 is shown as follows:

```
(submit) {"prompt": str, "placeholders": [{"name":
$\rightarrow$ str, "in_out": bool, "semantic_var_id": str,
$\rightarrow$ "transforms": str}, ...], "session_id": str}

(get) {"semantic_var_id": str, "criteria": str,
$\rightarrow$ "session_id": str}
```
...
def Generate(sampling_config: Dict, context_id: -- int, parent_context_id: int)
...
Total images found: 29

### Image 1

- **ID**: `img-0.jpeg`
- **Position**: (319, 305) to (462, 457)
- **Size**: 143 × 152 pixels

### Image 2

- **ID**: `img-1.jpeg`
- **Position**: (880, 1610) to (1550, 1707)
- **Size**: 670 × 97 pixels

### Image 3

- **ID**: `img-2.jpeg`
- **Position**: (880, 1744) to (1247, 1896)
- **Size**: 367 × 152 pixels

### Image 4

- **ID**: `img-3.jpeg`
- **Position**: (1275, 1744) to (1550, 1896)
- **Size**: 275 × 152 pixels

### Image 5

- **ID**: `img-4.jpeg`
- **Position**: (877, 193) to (1550, 519)
- **Size**: 673 × 326 pixels

### Image 6

- **ID**: `img-5.jpeg`
- **Position**: (171, 198) to (586, 433)
- **Size**: 415 × 235 pixels

### Image 7

- **ID**: `img-6.jpeg`
- **Position**: (588, 198) to (1062, 440)
- **Size**: 474 × 242 pixels

### Image 8

- **ID**: `img-7.jpeg`
- **Position**: (1062, 200) to (1533, 440)
- **Size**: 471 × 240 pixels

### Image 9

- **ID**: `img-8.jpeg`
- **Position**: (943, 613) to (1480, 919)
- **Size**: 537 × 306 pixels

### Image 10

- **ID**: `img-9.jpeg`
- **Position**: (146, 193) to (816, 360)
- **Size**: 670 × 167 pixels

### Image 11

- **ID**: `img-10.jpeg`
- **Position**: (943, 193) to (1480, 495)
- **Size**: 537 × 302 pixels

### Image 12

- **ID**: `img-11.jpeg`
- **Position**: (880, 191) to (1552, 462)
- **Size**: 672 × 271 pixels

### Image 13

- **ID**: `img-12.jpeg`
- **Position**: (911, 191) to (1519, 332)
- **Size**: 608 × 141 pixels

### Image 14

- **ID**: `img-13.jpeg`
- **Position**: (885, 202) to (1201, 451)
- **Size**: 316 × 249 pixels

### Image 15

- **ID**: `img-14.jpeg`
- **Position**: (1227, 202) to (1543, 451)
- **Size**: 316 × 249 pixels

### Image 16

- **ID**: `img-15.jpeg`
- **Position**: (146, 200) to (472, 437)
- **Size**: 326 × 237 pixels

### Image 17

- **ID**: `img-16.jpeg`
- **Position**: (487, 200) to (812, 437)
- **Size**: 325 × 237 pixels

### Image 18

- **ID**: `img-17.jpeg`
- **Position**: (882, 200) to (1200, 437)
- **Size**: 318 × 237 pixels

### Image 19

- **ID**: `img-18.jpeg`
- **Position**: (1225, 202) to (1547, 437)
- **Size**: 322 × 235 pixels

### Image 20

- **ID**: `img-19.jpeg`
- **Position**: (880, 622) to (1547, 866)
- **Size**: 667 × 244 pixels
...
- **ID**: `img-22.jpeg`
- **Position**: (919, 204) to (1511, 486)
- **Size**: 592 × 282 pixels

### Image 24

- **ID**: `img-23.jpeg`
- **Position**: (151, 200) to (465, 451)
- **Size**: 314 × 251 pixels

### Image 25

- **ID**: `img-24.jpeg`
- **Position**: (494, 200) to (807, 451)
- **Size**: 313 × 251 pixels

### Image 26

- **ID**: `img-25.jpeg`
- **Position**: (185, 576) to (768, 862)
- **Size**: 583 × 286 pixels

### Image 27

- **ID**: `img-26.jpeg`
- **Position**: (911, 200) to (1513, 475)
- **Size**: 602 × 275 pixels

### Image 28

- **ID**: `img-27.jpeg`
- **Position**: (919, 519) to (1504, 748)
- **Size**: 585 × 229 pixels

### Image 29

- **ID**: `img-28.jpeg`
- **Position**: (880, 193) to (1550, 495)
- **Size**: 670 × 302 pixels
